...
def load_data(_conn):
    ...
    # FIX 1: Call the utility function only ONCE for efficiency.
...
try:
    ...
    # Unpack all data. Note: 'critics_df' now contains critic stats.
...
if selected_game_name:
            ...
            with g_col1:
                raw_gauge = go.Figure(go.Indicator(
                    ...
                    gauge={'axis': {'range': [0, 10]}, 'bar': {'color': "#3498db"},
                           # FIX 2: Corrected the invalid hex color code here.
    ...
    with tab1:
        # Check if there are enough scores to create a density plot
    ...
    with tab3:
        ...
        st.dataframe(unrated_critics_df[['critic_name', 'critic_avg_pessimistic']], column_config={"critic_name": "Critic Name", "critic_avg_pessimistic": "Pessimistic Score"}, hide_index=True, use_container_width=True)